package com.lawyee.myaudioandpaly.baidu.recognization;
...
import com.lawyee.myaudioandpaly.baidu.util.FileUtil;
...
public class CommonRecogParams {
    ...
    public Map<String, Object> fetch(SharedPreferences sp) {
        ...
        if (sp.getBoolean("_outfile", false)) { // 保存录音文件
            ...
            map.put(SpeechConstant.OUT_FILE, samplePath +"/"+ FileUtil.Random6()+".pcm");
            Logger.info(TAG, "语音录音文件将保存在：" + samplePath + "/"+ FileUtil.Random6()+".pcm");
        }
