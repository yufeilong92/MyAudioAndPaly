...
import com.lawyee.myaudioandpaly.MainActivity;
...
import com.lawyee.myaudioandpaly.baidu.recognization.IStatus;
import com.lawyee.myaudioandpaly.baidu.recognization.MessageStatusRecogListener;
import com.lawyee.myaudioandpaly.baidu.recognization.StatusRecogListener;
...
public abstract class ActivityRecog extends MainActivity implements IStatus {
...
//                    txtResult.setText(msg.obj.toString());
    ...
    private void updateBtnTextByStatus() {
        switch (status) {
            ...
            case STATUS_SPEAKING:
            case STATUS_RECOGNITION:
                Log.e(TAG, "updateBtnTextByStatus: 222"+status );
                mBtnPlay.setText("录音中...");
                mBtnPlay.setEnabled(true);
                mImgSetting.setEnabled(true);
                break;

            case STATUS_STOPPED:
                Log.e(TAG, STATUS_STOPPED+"updateBtnTextByStatus:111 "+status );
//                mBtnPlay.setText("取消整个识别过程");
//                mBtnPlay.setEnabled(true);
//                mImgSetting.setEnabled(false);
                break;
            default:
                Log.e(TAG, "updateBtnTextByStatus: 00"+status );
                break;
        }
    }
}
